...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($user) {
        ...
        $stmt = $conn->prepare("UPDATE doctors_table SET ResetToken = ? WHERE Email = ?");
        ...
        $body = 'Hi ' . $email . ',<br><br>
                Forgot your password? We received a request to reset the password for your account.<br><br>
                Click the following link to reset your password: <br>
                <a href="https://mediflowhub.online/doctor/resetpassword.php?resettoken=' . $token . '">Reset Password</a><br><br>
                If you did not request a password reset, please ignore this email.';


               // <a href="http://localhost/dashboard/Capstone_PhpFiles/Capstone/doctor/resetpassword.php?resettoken=' . $token . '">Reset Password</a>
