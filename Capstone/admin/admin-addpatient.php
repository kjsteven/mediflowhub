...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO patients_table (First_name, Last_name, Date_of_Birth, Phone, Gender, Weight, Height) 
                            VALUES (?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("sssssss", $firstName, $lastName, $birthday, $phone, $gender, $weight, $height);
